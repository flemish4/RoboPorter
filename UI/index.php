...
<head>
	...
	<script src="resources/popper.js" crossorigin="anonymous"></script>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div id="connecting" class="alert alert-secondary">Connecting....</div>
						<div id="noconnection" class="alert alert-danger">No Connection Available</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						<button id="pagereloadconn" class="btn btn-success pagereload"  disabled>Reload Page<span class="glyphicon glyphicon-refresh"></span></button>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal fade" id="newmap-div" data-backdrop="static">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-primary" id="map-next-btn">Next</button>
						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					</div>
				</div>
			</div>
		...
		<div class="modal fade" id="noconnection-modal" data-backdrop="static">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div id="connecting" class="alert alert-info">An error connecting to the roboporter has occured</div>
					</div>
					<div class="modal-footer">
						<button class="btn btn-success pagereload">Reload Page</button>
					</div>
				</div>
			</div>
		</div>
								...
								<div class="col-12">
									<div class="tab-content" id="settings-content" style="margin:2%;">
										...
										<div class="tab-pane fade" id="user-settings" role="tabpanel" style="padding-top:1vh;">
											<div class="row">
												<div class="col-6">
													<div class="card" id="new_user_card">
														<div class="card-body">
			...
			<div class="row no-gutters">
				<div class="col-12 col-md-4">
					<div class="row justify-content-center" style="margin:1%;">
						<div class="col-6"><button class="btn btn-secondary" id="forward-btn"style="width:100%;">Forward</button></div>
					</div>	
					<div class="row justify-content-center" style="margin:1%;">
						<div class="col-6" ><button class="btn btn-secondary" id="left-btn" style="width:100%;">Left</button></div>
						<div class="col-6" ><button class="btn btn-secondary" id="right-btn" style="width:100%;">Right</button></div>
					</div>
					<div class="row justify-content-center" style="margin:1%;">
						<div class="col-6"><button class="btn btn-secondary" id="back-btn" style="width:100%;">Backwards</button></div>
					</div>
					<div class="row justify-content-center"style="margin:5%;">
						<button class="btn btn-danger" id="stop-btn" style="width:100%">STOP</button>
					</div>
					<div class="row justify-content-center"style="margin:5%;">
						<button class="btn" data-toggle="collapse" href="#manualcontrol">Manual Control</button>
					</div>
						...
						<div class="collapse" id="manualcontrol">
							<div class="col-12 card card-body text-center" >
								<div class="form-group">
									...
									<button type="submit" class="btn" style="margin:5%;" id="man-control-send" >Send</button>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-12 col-md-8">
					<div class="row justify-content-center" style="padding-left:5% ; ">
						<div class="col-12 text-center">
							<button class="btn btn-secondary" id="auto-btn" style="margin:1%;">Autopilot</button>
							<button class="btn btn-secondary" id="shutdown-btn" style="margin:1%;">Shutdown Server</button>
							<button class="btn btn-secondary" id="autopiolot-btn" style="margin:1%;">Safety ON/OFF</button>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="div-nav">
			...
			<div class="row justify-content-center no-gutters">
				<div class="col-12 col-md-8" id="mapdiv" style=" width:100%;">
					<canvas id="MapCanvas1" style="position:absolute; left:0; top:0; border-style:solid ;"></canvas>
				...
				<div class="col-12 col-md-4" style="padding:3%;" ;>
					<div class="row" style="margin-top:5% ;"><button class="btn btn-success" id="go-btn" style="margin-top:5% ; width:100%;">Go to Location on Map!</button></div>
					<div class="row" style="margin-top:5% ;"><button class="btn btn-primary" id="new-map-btn" style="margin-top:5%; width:100%;" data-toggle="modal" data-target="#newmap-div">Map New Floor</button></div>
